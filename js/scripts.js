...
function closeInfoFrame() {
  document.getElementById("google-inner-frame").style.display = 'none';
  document.getElementById("see-localisation").style.display = 'inline-block';
}

function showInfoFrame() {
  document.getElementById("google-inner-frame").style.display = 'block';
  document.getElementById("see-localisation").style.display = 'none';
}
